...
export default function Title({ title, theme2 }) {
    return (
        <div className={`relative p-2 px-3 group border-[1px] border-gray-500  duration-500  ${theme2 ? "hover:shadow-[0px_0px_5px_rgb(229,124,35)] hover:border-main-color2" : "hover:shadow-[0px_0px_5px_rgb(2,84,100)] hover:border-main-color1"}`}>
            ...
            <span className={`group-hover:right-[96%] group-hover:rotate-45  duration-500 w-2 h-2 bg-main-color4 absolute -top-1 -right-1 border-[1px]  ${theme2 ? "border-main-color2" : "border-main-color1"}`}></span>
            <span className={` group-hover:left-[96%] group-hover:rotate-45  duration-500 w-2 h-2 bg-main-color4 absolute -bottom-1 -left-1 border-[1px] ${theme2 ? "border-main-color2" : "border-main-color1"}`}></span>
