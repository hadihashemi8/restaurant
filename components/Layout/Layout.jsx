...
export default function Layout({ children }) {
    ...
    return (
        <div className="max-w-screen-2xl  min-h-screen mx-auto bg-main-color4 " dir="rtl">
            <header >
                <NavBar />
                <div className="p-4 grid grid-cols-1 sm:grid-cols-2 sm:grid-rows-3  relative h-[600px]" >
                    <Image alt="bg" src="/images/header-bg3-min.jpg" loading="lazy" fill sizes="100vw" style={{ objectFit: "cover" }} />
                    <div className="z-40 p-2 flex items-center justify-center sm:items-start col-span-1 sm:col-start-2 sm:col-end-3 sm:row-start-2 sm:row-end-4  ">
